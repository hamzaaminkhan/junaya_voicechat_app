...
class _VerifyEmailScreenState
  ...
  String _email = 'your email address';
  ...
  Future<void> _loadCurrentUser() async {
    try {
      ...
      // Verification check will handle
  ...
  Future<void> _logout() async {
    try {
      ...
      // BackendAuthService clears local tokens
