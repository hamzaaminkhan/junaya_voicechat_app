      ...
      builder: (context, snapshot) {
        ...
        return GridView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return MicSeat(username: username, micOn: mic);
          },
        );
      },
    );
    ...
    return Container(
      ...
      child: const Column(
        ...
        children: [
          ...
          Text("User joined the room", style: TextStyle(color: Colors.white54)),
        ],
      ),
    );
  }
  ...
  Widget bottomControls() {
    return Padding(
      ...
      child: Row(
        ...
        children: [
          controlButton(micOn ? Icons.mic : Icons.mic_off, () {
            setState(() {
              micOn = !micOn;
            });
          }),

          controlButton(Icons.card_giftcard, () {}),

          controlButton(Icons.chat, () {}),
        ],
      ),
    );
  }

  Widget controlButton(IconData icon, VoidCallback tap) {
    return CircleAvatar(
      radius: 28,
